...
export default class App extends Component {
  ...
  _onNetworkSelect = (network) => {
    console.log({network, action: 'onNetworkSelect'});
    if (!network) {
